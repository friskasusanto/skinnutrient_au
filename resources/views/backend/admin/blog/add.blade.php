@extends('backend.layouts.index', ['active' => 'tambah_blog'])
@section('title', 'Blog')
@section('content')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
			        ...
			        @endif
                    <form novalidate="novalidate" method="POST" action= "{{action('backend\admin\BlogController@add')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="text" class="form-control pull-right" id="" placeholder="judul blog" name="judul" required >
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <textarea type="text" class="form-control summernote" id="" name="text" required style="width: 100%" rows="10" ></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
