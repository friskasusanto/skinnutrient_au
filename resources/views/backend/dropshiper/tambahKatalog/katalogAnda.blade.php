...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-7 align-self-center">
            <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Katalog Anda</h4>
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        <li class="breadcrumb-item"><a href="index.html" class="text-muted">Dropshiper</a></li>
                        <li class="breadcrumb-item text-muted active" aria-current="page">Katalog Anda</li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <table id="zero_config" class="table table-striped table-bordered no-wrap">
                            ...
                            @if(count($product) != 0)
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <center>
                                        <a href="{{url('/dropship/katalogAnda/delete', $u->id)}}" class="btn btn-danger btn-icon-split btn-sm" style="font-size: xx-small;">
