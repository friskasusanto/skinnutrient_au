				...
				<div class="row">
        			<div class="col-lg-12">
        				<div class="section__title--3 text-center pb--30">
        					<h2>Ketentuan Sebagai Reseller</h2>
        					<!-- <p>eaoron.com.au</p> -->
        				</div>
        			</div>
        		</div>
        		<div class="row align-items-center">
        			<div class="col-lg-12 col-sm-12 col-12">
        				<div class="content">
                            ...
                            <form class="form form-validate floating-label" novalidate="novalidate" method="POST" action= "{{action('frontend\FrontendController@acc_reseller')}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                <div class="">
                                    <input name="dropshiper" value="reseller" type="checkbox">
                                    <span>Saya Setuju Dengan Semua Ketentuan Dropshiper</span>
                                </div>
                                <button class="button btn submite__btn" id="btn_submit" type="submit">Gabung</button>
                            </form>
        				</div>
        			</div>
        		</div>
